  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground overflow-x-hidden selection:bg-primary/20">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl mix-blend-multiply animate-blob"></div>
      ...
      <nav className="fixed top-0 w-full z-50 glass-panel border-b-0 rounded-none">
        <div className="container mx-auto flex justify-between items-center py-4">
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-chart-2">KUROKO PLUS</span>
          </div>
          <div className="hidden md:flex gap-8 text-sm font-medium text-muted-foreground">
            <a href="#features" className="hover:text-primary transition-colors">機能</a>
            <a href="#scenes" className="hover:text-primary transition-colors">利用シーン</a>
            <a href="#future" className="hover:text-primary transition-colors">将来展望</a>
          </div>
      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-in slide-in-from-bottom-10 duration-700 fade-in">
            <Badge variant="secondary" className="px-4 py-1.5 text-sm rounded-full bg-primary/10 text-primary border-primary/20 font-medium">
              <Sparkles className="w-3.5 h-3.5 mr-2 inline" />
              AI Conversation Assistant
            </Badge>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.1]">
              会話の裏方、<br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-chart-2 to-chart-3">
                デジタル黒子
              </span>
              が<br />支えます。
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button size="lg" className="rounded-full h-12 px-8 text-base shadow-xl shadow-primary/20 hover:shadow-primary/30 transition-all">
      ...
      <section id="features" className="py-24 px-6 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
            ...
            <div className="md:col-span-2 bento-card p-8 flex flex-col md:flex-row items-center gap-8 group bg-gradient-to-br from-white to-blue-50/50">
              ...
              <div className="flex-1 w-full h-48 rounded-2xl overflow-hidden shadow-lg border border-border/50 relative group-hover:scale-[1.02] transition-transform duration-500">
                <img src="/images/feat_summary.png" alt="Summary UI" className="w-full h-full object-cover" />
              </div>
            </div>

            {/* Feature 2: Explanation (Tall) */}
            <div className="md:row-span-2 bento-card p-8 flex flex-col gap-6 group bg-gradient-to-br from-white to-purple-50/50">
              ...
              <div className="flex-1 w-full rounded-2xl overflow-hidden shadow-lg border border-border/50 relative mt-auto group-hover:scale-[1.02] transition-transform duration-500">
                <img src="/images/feat_explain.png" alt="Explanation UI" className="w-full h-full object-cover" />
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1 space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold">
                あらゆるシーンで、<br />
                <span className="text-primary">スマート</span>にサポート。
              </h2>
      ...
      <footer className="py-12 px-6 border-t border-border/50 bg-muted/20">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-sm font-medium text-muted-foreground">
            <a href="#" className="hover:text-primary transition-colors">プライバシー</a>
